...
class GameClient:
    ...
    def send_command_string(self, command_value):   # Edited!
        self.__send(command_value)                  # Edited!
    ...
    def __send(self, data: str) -> int:
        print("Sending:", data)				   # Edited!
        return self.connection.send(data)

    def __recv(self) -> str:
        x = self.connection.recv()			   # Edited!
        print("Received:", x)				   # Edited!
        return x
